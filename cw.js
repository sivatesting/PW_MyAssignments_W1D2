var listOfSavingAccountNumbers = ["1000", "1001", "1002"];
var listOfCheckingAccountNumbers = ["10000", "10001", "10002"];
...
var accType = prompt("Enter account type");
var accountNumber = prompt("Eenter account number");
function openNewAccount(userName, accountType, openingBalance) {
    /**
    ...
    var newAccountNumber = generateNewAccountNumber(accountType);
    if (accountType == "Savings") {
        listOfSavingAccountNumbers.push(newAccountNumber);
        console.log("New account is created for ".concat(userName, " and balance is ").concat(openingBalance));
    }
...
function generateNewAccountNumber(accountType) {
    var newAccountNumber;
    var count = 0;
    if (accountType == "Savings") {
        for (var i = 0; i < listOfSavingAccountNumbers.length; i++) {
        ...
        if (count == listOfSavingAccountNumbers.length) {
            ...
            console.log("New Account no. ".concat(newAccountNumber));
        }
        //   isValidAccount(accountNumber, accType)
    }
    if (accountType == "Checking") {
        for (var i = 0; i < listOfCheckingAccountNumbers.length; i++) {
...
console.log("List of Saving Account Numbers ".concat(listOfSavingAccountNumbers));
console.log("List of Checking Account Numbers ".concat(listOfCheckingAccountNumbers));
