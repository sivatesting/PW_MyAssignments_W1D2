...
signUpToSlack()
.then(()=> addProfilePic())
.then(()=> postNotificationInIntroChannel())
.then(()=> finalStatusPrint())
.catch((error)=> console.error(`Something went wrong`)) //change isDbConnectionFine to false in line no. 9 to catch error.